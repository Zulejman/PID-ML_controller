...
class Plant(ABC):
    ...
    def __init__(self, file_name):
        ...
        self.disturbance_range = global_parameters.get("disturbance_range", 0)
        self.disturbance = 0 
        self.additional_parameters = global_parameters.get("additional_parameters", 0)
    ...
    def generate_disturbance(self):
        self.disturbance = random.uniform(*self.disturbance_range)
